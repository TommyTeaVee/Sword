...
# Header
echo -e "${YELLOW}${UNDERLINE}Version:${NC} 4 ${YELLOW}${UNDERLINE}CTRL+C:${NC} exit ${YELLOW}${UNDERLINE}Author:${NC} 4lbH4cker"

# Menu
echo -e "${WHITE}[1]${BLUE} Requests & Update  ${WHITE}[2]${BLUE} Phishing Tool"
echo -e "${WHITE}[3]${BLUE} WebCam Hack        ${WHITE}[4]${BLUE} Subscan"
# ... rest of menu items ...

echo -e "\033[33;4mVersion:\033[0m 4 \033[33;4mCTRL+C:\033[0m exit \033[33;4mAuthor:\033[0m 4lbH4cker"
echo -e "\e[37m[1]\e[36m Requests & Update  \e[37m[2]\e[36m Phishing Tool"
echo -e "\e[37m[3]\e[36m WebCam Hack        \e[37m[4]\e[36m Subscan"
echo -e "\e[37m[5]\e[36m Gmail Bomber       \e[37m[6]\e[36m DDOS Attack"
echo -e "\e[37m[7]\e[36m How to use ?       \e[37m[8]\e[36m Uninstall downloaded programs"
echo -e "\e[37m[9]\e[36m Ip Info            \e[37m[10]\e[36m dorks-eye"
echo -e "\e[37m[11]\e[36m HackerPro          \e[37m[12]\e[36m RED_HAWK"
echo -e "\e[37m[13]\e[36m VirusCrafter       \e[37m[14]\e[36m Info-Site"
echo -e "\e[37m[15]\e[36m BadMod             \e[37m[16]\e[36m Facebash"
echo -e "\e[37m[17]\e[36m DARKARMY           \e[37m[18]\e[36m AUTO-IP-CHANGER"
...
if [[ $islem == 1 || $islem == 01 ]]; then
    ...
    apt upgrade -y
    clear
    echo -e "\033[47;3;35m Updating complete...\033[0m"
    sleep 3
    bash alhack.sh
